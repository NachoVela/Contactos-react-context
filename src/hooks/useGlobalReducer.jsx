...
export function StoreProvider({ children }) {
    ...
    async function getContactList() {
        ...
        try {
            const response = await fetch("https://playground.4geeks.com/contact/docs", requestOptions);
    ...
    async function deleteContact(id) {
        ...
        try {
            const response = await fetch(`https://playground.4geeks.com/contact/docs${id}`, requestOptions)
        } catch (error) {
            console.error(error);
        };
    }
